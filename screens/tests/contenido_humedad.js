...
const formula = require('../../assets/ContenidoHumedad.png')

export default function ContenidoHumedad() {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.navbar}>
                ...
                {/* Nombre del ensayo */}
                <Text style={styles.title}>Contenido de Humedad</Text>
            ...
            <View style={[styles.content, { flex: 1 }]}>
                ...
                {/* Nombre del Proyecto */}
                <Text style={styles.titleProject}>Proyecto 1</Text>
                ...
                <View style={{ flex: 1, justifyContent: 'flex-end', alignItems: 'center' }}>
                    <Image source={formula} resizeMode="contain"
